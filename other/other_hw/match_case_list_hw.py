...
match book:
    case (_, str() as author, str() as namebook) if len(author) > 5 and len(namebook) > 10:
        print ("Yes")
    case (_, str() as author, str() as namebook, float() as price) if len(author) > 5 and price > 0:
        print ("Yes")
    case (_, str(), str(), int() as year) if year > 2019:
        print ("Yes")
    case (_, str(), str(), float() as price, int() as year) if price > 0 and year > 2019:
        print ("Yes")
